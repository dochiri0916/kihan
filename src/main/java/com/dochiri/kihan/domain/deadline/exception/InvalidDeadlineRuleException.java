...
public class InvalidDeadlineRuleException extends DeadlineException {
    ...
    private static final String RECURRING_START_DATE_REQUIRED = "RECURRING 마감은 startDate가 필수입니다.";
    ...
    public static InvalidDeadlineRuleException recurringStartDateRequired() {
        return new InvalidDeadlineRuleException(RECURRING_START_DATE_REQUIRED);
    }
